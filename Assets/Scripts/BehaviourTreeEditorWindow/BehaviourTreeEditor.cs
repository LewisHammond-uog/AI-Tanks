...
namespace BehaviourTreeEditorWindow
{
    public class BehaviourTreeEditor : UnityEditor.EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            // Import UXML
            VisualTreeAsset visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/BehaviourTreeEditorWindow/StyleSheets/BehaviourTreeEditor.uxml");
            visualTree.CloneTree(root);

            // A stylesheet can be added to a VisualElement.
            // The style will be applied to the VisualElement and all of its children.
            StyleSheet styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Scripts/BehaviourTreeEditorWindow/StyleSheets/BehaviourTreeEditor.uss");
